            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  ...
                  Ramaiah Institute of Technology (2021-2023)
                </li>
                <li>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  ...
                  <p>
                    At Donyati India Pvt Ltd, I specialize in developing
                    solutions using React JS and Python, integrating Azure AI
                    Services and OpenAI for AI driven applications. By
                    leveraging Azure cloud services, I enhance productivity
                    while focusing on both front-end and back-end development. I
                    create dynamic, user-friendly interfaces and scalable
                    architectures, collaborating with cross functional teams to
                ...
                <div>
                  ...
                  <p>
                    ...
                    problem-solving skills, and learned to collaborate
                    effectively with a team of developers. My primary project
                    was the development of the "New Gandhi Sakchi Kayaka (NGSK)"
                    application
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    ...
                    development for Power Pages, creating interactive and
                    dynamic web pages to enhance user experience. I contributed
                    to building scalable and efficient web solutions, and my
                    major project involved developing Power Platform solutions
                    for SunTrust Banks using Power Apps
                  </p>
                </div>
              </div>
            </div>
