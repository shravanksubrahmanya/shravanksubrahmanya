/* ── Speech bubble that appears beside the robot (desktop) or as bottom toast (mobile) ── */
export const SpeechBubble = ({
  ...
  if (isMobile) {
    return (
      ...
      >
        <div
          className="border border-white/15 rounded-2xl px-4 py-3 shadow-2xl"
          style={{
        ...
        >
          ...
          <p className="text-xs leading-relaxed" style={{ color: "rgba(255,255,255,0.92)" }}>{text}</p>
        </div>
      </div>
    );
  }

  /* ── Desktop: absolute side-positioned bubble ── */
  return (
    <div
      style={{
        position: "absolute",
